...
Partial Class ServicioGeneracionComprobantesElectronicos
    ...
    Shared Sub Main()
        ...
        '
        ServicesToRun = New System.ServiceProcess.ServiceBase() {New ServicioGeneracionComprobantesElectronicos}
    ...
    Private Sub InitializeComponent()
        '
        'ServicioGeneracionComprobantesElectronicos
        '
        Me.ServiceName = "Servicio de generación de comprobantes electrónicos"
