...
'
Namespace ec.gob.sri.cel.autorizacionProduccion
    ...
    Partial Public Class AutorizacionComprobantesOfflineService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.ClasesComprobantesElectronicos.My.MySettings.Default.ClasesComprobantesElectronicos_ec_gob_sri_cel_autorizacionProduccion_AutorizacionComprobantesService
