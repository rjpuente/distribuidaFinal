...
import net.feria.controlador.ImpresionFisica;
 ...
 * @author Deth1
 */
public class CrearFacturaRuc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldClienteBuscar = new javax.swing.JTextField();
        ...
        jTextFieldClienteBuscar.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N

        jButtonBuscar.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jScrollPaneItems, javax.swing.GroupLayout.DEFAULT_SIZE, 542, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jTextFieldClienteBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextFieldClienteBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButtonBuscar))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 10, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jComboBoxClientes, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE)
                        .addGap(28, 28, 28))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jButtonNuevoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonGenerarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGenerarFacturaActionPerformed
        ...
        if (!listaProductosFactura.isEmpty()) {
            ...
            totalSinIva = listaProductosFactura.stream()
                    .map((item) -> item.getCantidad() * item.getCodigoItem().getPrecioItem().doubleValue() / IVA_PORCENTAHE).reduce(totalSinIva, (accumulator, _item) -> accumulator + _item);
            
            facturaCabecera.setValorTotalFactura(BigDecimal.valueOf(totalSinIva * IVA_PORCENTAHE));
            facturaCabecera.setIva(BigDecimal.valueOf(facturaCabecera.getValorTotalFactura().doubleValue() - totalSinIva));
            facturaCabecera.setValorDescuento(BigDecimal.ZERO);
    ...
    private void buscarCliente() {
        String textoBusqueda = jTextFieldClienteBuscar.getText().trim().toLowerCase();
        ...
        listaClientes.stream()
                ...
                .forEach(cliente -> jComboBoxClientes.addItem(cliente.getNombre()));
    }
    ...
    private void IniciarProcesoComprobanteElectronico() {
        ...
        try {
            ...
            ImpresionFisica impresion = new ImpresionFisica();
            impresion.imprimir(comprobanteElectronico);
        } catch (Exception ex) {
            Logger.getLogger(CrearFacturaRuc.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearFacturaRuc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrearFacturaRuc().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldClienteBuscar;
